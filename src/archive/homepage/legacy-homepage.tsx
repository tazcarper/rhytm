// ARCHIVED — 2026-07-19. This was the "/" homepage (adventures band,
// manifesto pullquote, how-it-works, final CTA) until it was replaced by the
// club-selector gateway at app/page.tsx, which sends visitors straight to
// each property's own marketing site instead of a shared umbrella page.
// Nothing was deleted — this file is unwired from any route and not
// imported anywhere. To bring it back, wire this component into a route
// again (e.g. re-export it from app/page.tsx).
...
import s from "./legacy-homepage.module.css";
      ...
      <section className={s.finalCta}>
        <div className={s.finalCtaInner}>
          ...
          <div className={s.finalCtaActions}>
            <Button asChild variant="secondary" size="lg">
              <Link href="/request-estimate">Request an estimate</Link>
            </Button>

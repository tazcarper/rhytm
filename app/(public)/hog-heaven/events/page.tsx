...
const DEFAULT_MEMBERS_CTA = {
  ...
  body: "Members receive early registration access and member-only invitations to everything on the calendar.",
...
export default async function HogHeavenEventsPage() {
  ...
  return (
    <>
      ...
      {/* Included with Membership — mockup's bg-moss is this theme's "sage"
          token, see the education page's CTA comment for the naming
          mismatch. */}
      ...
      <Section tone="sage" className="text-center text-white">
        ...
        />
        <PropertyButton href={membersCta.ctaHref} variant="primary" className="mt-8">
          {membersCta.ctaLabel}
        </PropertyButton>
      </Section>
    </>
